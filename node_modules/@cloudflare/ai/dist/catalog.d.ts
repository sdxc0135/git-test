...
export declare const modelMappings: {
    ...
    readonly "object-detection": {
        readonly models: readonly ["@cf/meta/detr-resnet-50"];
        readonly class: typeof AiObjectDetection;
        readonly id: "9c178979-90d9-49d8-9e2c-0f1cf01815d4";
    };
    readonly "text-generation": {
        readonly models: readonly ["@cf/meta/llama-2-7b-chat-int8", "@cf/mistral/mistral-7b-instruct-v0.1", "@cf/meta/llama-2-7b-chat-fp16", "@hf/thebloke/llama-2-13b-chat-awq", "@hf/thebloke/zephyr-7b-beta-awq", "@hf/thebloke/mistral-7b-instruct-v0.1-awq", "@hf/thebloke/codellama-7b-instruct-awq"];
...
export declare const modelSettings: {
    ...
    "@hf/thebloke/llama-2-13b-chat-awq": {
        ...
        postProcessingFunc: (response: any) => any;
        postProcessingFuncStream: (response: any) => any;
    };
